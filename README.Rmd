...
To install the most up-to-date version of MixMashNet, you can install it from [GitHub](https://github.com/) with:
...
Here, covariates (`AGE`, `SEX`) are included in the estimation to adjust the network, but they are excluded from the visualization and centrality metrics.
